  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'transport/glue/sequenced_write_stream_socket.h',
        'transport/glue/sequenced_write_stream_socket.cc',
        'transport/glue/framed_write_stream_socket.h',
        'transport/glue/framed_write_stream_socket.cc',
        'transport/glue/udp_channel_factory.h',
        'transport/glue/udp_channel_factory.cc',
        'transport/glue/tcp_channel_factory.h',
        'transport/glue/tcp_channel_factory.cc',
        'transport/glue/tls_channel_factory.h',
        'transport/glue/tls_channel_factory.cc',
        'transport/glue/ws_channel_factory.h',
        'transport/glue/ws_channel_factory.cc',
      ],
    },  # target sippet
  ],
}
