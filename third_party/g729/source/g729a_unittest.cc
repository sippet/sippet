...
class G729Test : public testing::Test {
 ...
 protected:
  static const UWord8 expected_bits_[10];
  static const Word16 expected_parm_[PRM_SIZE];
};

const UWord8 G729Test::expected_bits_[10] = {
  0x1a, 0xc1, 0x00, 0xa0, 0x00, 0xfa, 0xc2, 0xff, 0xfd, 0x50,
};

const Word16 G729Test::expected_parm_[PRM_SIZE] = {
...
TEST_F(G729Test, bits2prm) {
  ...
  bits2prm_ld8k(expected_bits_, output_parm);

  EXPECT_PRED_FORMAT3(AssertSameArrays, expected_parm_, output_parm,
    PRM_SIZE);
}

TEST_F(G729Test, prm2bits) {
  UWord8 output_bits[10];
  prm2bits_ld8k(expected_parm_, output_bits);

  EXPECT_PRED_FORMAT3(AssertSameArrays, expected_bits_, output_bits,
    10);
}
