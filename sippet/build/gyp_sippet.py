...
# gyp_sippet when GYP_PARALLEL=1 and it creates sub-processes
...
# __init__.py). This wrapper makes "import gyp_sippet" work with
# those old versions and makes it possible to execute gyp_sippet.py
# directly on Windows where the extension is useful.

import os

path = os.path.abspath(os.path.split(__file__)[0])
execfile(os.path.join(path, 'gyp_sippet'))
