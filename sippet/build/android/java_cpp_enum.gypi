...
#
# This modified version also accepts C preprocessor directives.
#
...

{
  'variables': {
    ...
    'generator_path': '<(DEPTH)/sippet/build/android/gyp/java_cpp_enum.py',
    'extra_opts%': [ '-I', '<(DEPTH)' ],
  ...
  'actions': [
    {
      ...
      'action': [
        'python', '<(generator_path)', '<@(extra_opts)', '<@(generator_args)'
      ],
